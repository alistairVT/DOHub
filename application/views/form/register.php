...
<form action="" method="post" id="formbox" onsubmit="JavaScript:return check();">
		...
		<input class="logininput" type="text" placeholder="ID number" id = "id" name="id" maxlength="8" autofocus/><br/>
		<b>First Name</b></br>
		...
		<input class="logininput" type="text" placeholder="violcode" id = "violcode" name="violcode" maxlength="75" autofocus/><br/>
