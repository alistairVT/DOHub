<form action="" method="post" id="formbox" onsubmit="">
		...
		Reason/s for violating the current alleged offense<br>
		<input type="text" id = "reason" name="reason" maxlength="500"/>
	<table >
		<tr><td colspan="3">Due to:</td></tr>
		<tr>
		<td><input data-enable = "pconcerns"  type="checkbox" id = "cpconcerns" name="cpconcerns"/></td>
		<td class="input"> Personal Concerns </td> 
		<td class="input"><input type="text" id = "pconcerns" name="pconcerns" maxlength="500" /></td></tr></br>

		<tr>
		<td><input data-enable = "sconcerns"  type="checkbox" id = "csconcerns" name="csconcerns" /></td>
		<td class="input">Social Concerns</td>
		<td class="input"><input  type="text" id = "sconcerns" name="sconcerns" maxlength="500" disabled/></td></tr><br>

		<tr>
		<td><input data-enable = "aconcerns"  type="checkbox" id = "caconcerns" name="caconcerns" /></td>
		<td class="input">Academic Concerns</td>
		<td class="input"><input  type="text" id = "aconcerns" name="aconcerns" maxlength="500" disabled/></td></tr></br>

		<tr>
		<td><input data-enable = "cconcerns"  type="checkbox" id = "ccconcerns" name="ccconcerns"/></td>
		<td class="input">Career Concerns</td>
		<td class="input"><input  type="text" id = "cconcerns" name="cconcerns" maxlength="500" disabled/></td></tr></br>

		<tr>
		<td><input data-enable = "oconcerns"  type="checkbox" id = "coconcerns" name="coconcerns"/></td>
		<td class="input">Others</td>
